      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="glass rounded-2xl p-6 slide-in" style={{ animationDelay: "0.7s" }}>
          ...
          <div className="space-y-3">
            <button className="w-full p-4 rounded-xl bg-gradient-to-r from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 hover:border-cyan-500/50 hover:from-cyan-500/30 hover:to-blue-500/30 transition-all group flex items-center gap-3">
