...
def create_ticket(db: Session, ticket: schemas.TicketCreate, created_by_id: int) -> Ticket:
    db_ticket = Ticket(
        title=ticket.title,
...
def update_ticket(db: Session, ticket_id: int, ticket_update: schemas.TicketUpdate) -> Optional[Ticket]:
